...
test "fill boolean" {
    ...
    try runTest("\"a\"^`boolean$()", .{ .char_list = &.{} });
...
test "fill symbol" {
    ...
    try runTest("`symbol^`$()", .{ .symbol_list = &.{} });
