...
pub fn disassembleInstruction(chunk: *const Chunk, offset: usize) usize {
    ...
    return switch (instruction) {
        ...
        .op_null => simpleInstruction(.op_null, offset),
        .op_fill => simpleInstruction(.op_fill, offset),
        .op_length => simpleInstruction(.op_length, offset),
        .op_take => simpleInstruction(.op_take, offset),
        .op_floor => simpleInstruction(.op_floor, offset),
        .op_drop => simpleInstruction(.op_drop, offset),
        .op_string => simpleInstruction(.op_string, offset),
        .op_cast => simpleInstruction(.op_cast, offset),
        .op_unique => simpleInstruction(.op_unique, offset),
        .op_find => simpleInstruction(.op_find, offset),
        .op_type => simpleInstruction(.op_type, offset),
        .op_apply_1 => simpleInstruction(.op_apply_1, offset),
        .op_value => simpleInstruction(.op_value, offset),
        .op_apply_n => simpleInstruction(.op_apply_n, offset),
